...
export const getRoomRequest = () => ({ type: GET_ROOM_REQUEST,
  payload: {} })

export const getRoomSuccess = (room: Models.Room[]) => ({ type: GET_ROOM_SUCCESS,
  payload: room })
...
export const makeRoomRequest = (inviteUsers: InviteUser[]) => ({ type: MAKE_ROOM_REQUEST,
  payload: inviteUsers })
...
export const makeRoomSuccess = ({ room, roomUuid }: MakeRoomSuccess) => ({ type: MAKE_ROOM_SUCCESS,
  payload: { room, roomUuid } })
