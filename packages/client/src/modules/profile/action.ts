...
export const getProfileSuccess = (profile: Models.User) => ({ type: GET_PROFILE_SUCCESS,
  payload: profile })
...
export const updateProfileRequest = (profile: {
  ...
  payload: profile })
export const updateProfielSuccess = (profile: Models.User) => ({ type: UPDATE_PROFILE_SUCCESS,
  payload: profile })
