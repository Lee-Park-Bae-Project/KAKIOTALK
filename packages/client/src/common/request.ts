...
export const getProfile = () => Axios<ApiTypes.Profile>({
  method: 'GET',
  url: 'user/my-profile',
})
...
export const getFirstChat = ({ roomUuid }: GetFirstChat) => Axios<ApiTypes.GetFirstChat>({
  method: 'GET',
...
export const getRooms = () => Axios<ApiTypes.GetRoom[]>({
  method: 'GET',
  url: 'chat/room',
})
